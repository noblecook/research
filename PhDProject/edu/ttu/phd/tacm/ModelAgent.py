    ...
    if node != None:
        try:
            ...
            if node.tag == 'CFRTITLE':
                print('CFRTITLE ---------------->>> ')
                CFRTITLE_Literal = rdflib.Literal('http://www.shamroq.pcook.ttu.edu/'+node.text.replace(' ',''))
                g.add((REG_21_CFR_11_10,has_CFRTITLE,CFRTITLE_Literal))
            if node.tag == 'CFRTITLETEXT':
                print('CFRTITLETEXT ---------------->>> ')
                CFRTITLETEXT_Literal = rdflib.Literal('http://www.shamroq.pcook.ttu.edu/'+node.text.replace(' ',''))
                g.add((REG_21_CFR_11_10,has_CFRTITLETEXT,CFRTITLETEXT_Literal))
            if node.tag == 'VOL':
                print('VOL FOUND ---------------->>> ')
                VOL_Literal = rdflib.Literal('http://www.shamroq.pcook.ttu.edu/'+node.text.replace(' ',''))
                g.add((REG_21_CFR_11_10,has_VOL,VOL_Literal))
            if node.tag == 'DATE':
                print('DATE FOUND ---------------->>> ')
                DATE_Literal = rdflib.Literal('http://www.shamroq.pcook.ttu.edu/'+node.text.replace(' ',''))
                g.add((REG_21_CFR_11_10,has_DATE,DATE_Literal))
            if node.tag == 'ORIGINALDATE':
                print('ORIGINALDATE FOUND ---------------->>> ')
                ORIGINALDATE_Literal = rdflib.Literal('http://www.shamroq.pcook.ttu.edu/'+node.text.replace(' ',''))
                g.add((REG_21_CFR_11_10,has_ORIGINALDATE,ORIGINALDATE_Literal))
            if node.tag == 'COVERONLY':
                print('COVERONLY FOUND ---------------->>> ')
                COVERONLY_Literal = rdflib.Literal('http://www.shamroq.pcook.ttu.edu/'+node.text.replace(' ',''))
                g.add((REG_21_CFR_11_10,has_COVERONLY,COVERONLY_Literal))
            if node.tag == 'TITLE':
                print('TITLE FOUND ---------------->>> (please REMOVE period ')
                TITLE_Literal = rdflib.Literal('http://www.shamroq.pcook.ttu.edu/'+node.text.replace(' ',''))
                g.add((REG_21_CFR_11_10,has_TITLE,TITLE_Literal))
            if node.tag == 'GRANULENUM':
                print('GRANULENUM FOUND ---------------->>> ')
                GRANULENUM_Literal = rdflib.Literal('http://www.shamroq.pcook.ttu.edu/'+node.text.replace(' ',''))
                g.add((REG_21_CFR_11_10,has_GRANULENUM,GRANULENUM_Literal))
            if node.tag == 'HEADING':
                print('HEADING FOUND ---------------->>> ')
                HEADING_Literal = rdflib.Literal('http://www.shamroq.pcook.ttu.edu/'+node.text.replace(' ',''))
                g.add((REG_21_CFR_11_10,has_HEADING,HEADING_Literal))
            if node.tag == 'ANCESTORS':
                print('ANCESTORS FOUND ---->>> ')
                ANCESTORS_Literal = rdflib.Literal('http://www.shamroq.pcook.ttu.edu/'+node.text.replace(' ',''))
                g.add((REG_21_CFR_11_10,has_ANCESTORS,ANCESTORS_Literal))
            if node.tag == 'PARENT':
                print('PARENT FOUND ---------------->>> ')
                PARENT_Literal = rdflib.Literal('http://www.shamroq.pcook.ttu.edu/'+node.text.replace(' ',''))
                g.add((REG_21_CFR_11_10,has_PARENT,PARENT_Literal))     
            if node.tag == 'SECTION':
                print ('SECTION')
        except:
